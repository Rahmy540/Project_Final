package com.example.movieappapi.activities;
        ...
        call.enqueue(new Callback<MovieDetail>() {
            ...
            public void onResponse(Call<MovieDetail> call, Response<MovieDetail> response) {
                if (response.isSuccessful() && response.body() != null){
                    ...
                    Glide.with(DetailMovieActivity.this).load(uri).into(ivBackdrop);
                    Glide.with(DetailMovieActivity.this).load(uri2).into(ivPoster);
